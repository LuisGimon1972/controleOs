...
if (os.status) {
  ...
  if (status === 'FATURADA') {
    ...
    linha.style.backgroundColor = '#787979ff'; 
...
const nf = v => Number(v || 0).toFixed(2);
const totaloss= (os.valorProdutos + os.valorServicos) + os.acrescimo - os.desconto - os.adiantamento
linha.innerHTML = `
...
<td style="font-family: Arial; font-size: 9pt; text-align: right;">${nf(os.valorProdutos)}</td>
<td style="font-family: Arial; font-size: 9pt; text-align: right;">${nf(os.valorServicos)}</td>
<td style="font-family: Arial; font-size: 9pt; text-align: right;">${nf(os.desconto)}</td>
<td style="font-family: Arial; font-size: 9pt; text-align: right;">${nf(os.acrescimo)}</td>
<td style="font-family: Arial; font-size: 9pt; text-align: right;">${nf(os.adiantamento)}</td>
<td style="font-family: Arial; font-size: 9pt; text-align: right; font-weight: bold;">
  ${nf(totaloss)}
</td>
